...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="D8BF6992:5099:2EB2E14F:564E3827" name="octolytics-dimension-request_id" />
...
<meta content="Rails, view, blob#show" data-pjax-transient="true" name="analytics-event" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta content="6df7a2bb7a21fd45b75ea01d28bfbe433604f5a3" name="form-nonce" />
  ...
  <div class="container clearfix">
    ...
    <div class="site-search repo-scope js-site-search" role="search">
      <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/tmuxinator/tmuxinator/search" class="js-site-search-form" data-global-search-url="/search" data-repo-search-url="/tmuxinator/tmuxinator/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders"
  ...
  <ul class="sunken-menu-group">
    <li class="tooltipped tooltipped-w" aria-label="Code">
      <a href="/tmuxinator/tmuxinator" aria-label="Code" aria-selected="true" class="js-selected-navigation-item selected sunken-menu-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /tmuxinator/tmuxinator">
...
<div class="js-clone-url clone-url open"
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini text-small text-muted input-monospace js-url-field js-zeroclipboard-target"
           value="https://github.com/tmuxinator/tmuxinator.git" readonly="readonly" aria-label="HTTPS clone URL">
...
<div class="js-clone-url clone-url "
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini text-small text-muted input-monospace js-url-field js-zeroclipboard-target"
           value="https://github.com/tmuxinator/tmuxinator" readonly="readonly" aria-label="Subversion checkout URL">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard btn btn-sm zeroclipboard-button tooltipped tooltipped-s" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
...
<div class="clone-options text-small text-muted">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="6df7a2bb7a21fd45b75ea01d28bfbe433604f5a3" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="UVBVcE5Yr1PmUQpITwjXFhCUmll+HClFhhDDwgD0QmPcKMdkfBIGItvfRDQK2kxHkYkQ/aYww7xOQNx+LxIhyg==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-form-nonce="6df7a2bb7a21fd45b75ea01d28bfbe433604f5a3" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="hrgCrElnzrCBXO9ulVJNrMi0nozdz7dWRGhplOGPm+JaEdfFvbh2OyQtEmtyQgeWY3XTsAq6pjw4Ju07D49BMw==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/tmuxinator/tmuxinator/blob/f938953d0e9bdcbcc041c288d1b29d01767317ff/completion/tmuxinator.zsh" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:706695f5d3276fc8aca8011e22a435d9 -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/tmuxinator/tmuxinator/tree/v0.7.0/completion/tmuxinator.zsh"
                 data-name="v0.7.0"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="commit-tease">
      <span class="right">
        <a class="commit-tease-sha" href="/tmuxinator/tmuxinator/commit/fba8f7b8e357ee5276dc9e2076cc8597ded33de4" data-pjax>
          fba8f7b
        </a>
        <time datetime="2015-01-04T13:21:31Z" is="relative-time">Jan 4, 2015</time>
      </span>
      <div>
        <img alt="@ohcibi" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/61993?v=3&amp;s=40" width="20" />
        <a href="/ohcibi" class="user-mention" rel="contributor">ohcibi</a>
      ...
      <a class="muted-link contributors-toggle" href="#blob_contributors_box" rel="facebox">
        <strong>2</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="Soliah" href="/tmuxinator/tmuxinator/commits/master/completion/tmuxinator.zsh?author=Soliah"><img alt="@Soliah" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/141213?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="ohcibi" href="/tmuxinator/tmuxinator/commits/master/completion/tmuxinator.zsh?author=ohcibi"><img alt="@ohcibi" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/61993?v=3&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@Soliah" height="24" src="https://avatars0.githubusercontent.com/u/141213?v=3&amp;s=48" width="24" />
            <a href="/Soliah">Soliah</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@ohcibi" height="24" src="https://avatars0.githubusercontent.com/u/61993?v=3&amp;s=48" width="24" />
...
<div class="file">
  ...
  <div class="blob-wrapper data type-shell">
      ...
      <tr>
        ...
        <td id="LC5" class="blob-code blob-code-inner js-file-line">  commands=(<span class="pl-smi">${(f)<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-s"><span class="pl-pds">$(</span>tmuxinator commands zsh<span class="pl-pds">)</span></span><span class="pl-pds">&quot;</span></span>}</span>)</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line">  projects=(<span class="pl-smi">${(f)<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-s"><span class="pl-pds">$(</span>tmuxinator completions start<span class="pl-pds">)</span></span><span class="pl-pds">&quot;</span></span>}</span>)</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05104s from github-fe119-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
